...
def testing(new_translation):
	if all(matching(new_translation)[x] == e[x] for x in xrange(len(e))): #Check that translated and original words are the same
		print "No one letter contractions." #If they are, congrats!
	else: print "One letter contractions exist." 
